package com.platform.mesh.app.biz.modules.app.formcolumnmapping.domain.po;
...
@TableName(value = "app_form_column_mapping", autoResultMap = true)
public class AppFormColumnMapping extends BasePO {
