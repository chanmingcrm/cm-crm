package com.platform.mesh.app.biz.modules.app.formcolumnsetting.domain.vo;
...
@Schema(description ="表单字段配置VO")
public class AppFormColumnSettingVO extends BaseVO {
