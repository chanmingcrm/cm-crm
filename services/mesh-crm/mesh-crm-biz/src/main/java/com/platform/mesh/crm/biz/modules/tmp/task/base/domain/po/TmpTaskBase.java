package com.platform.mesh.crm.biz.modules.tmp.task.base.domain.po;
...
@TableName(value = "tmp_task_base", autoResultMap = true)
public class TmpTaskBase extends AppPO {
