package com.platform.mesh.crm.biz.modules.crm.oninvoice.domain.vo;
...
/**
 * @description 客户关系发票回执VO
 * @author 蝉鸣
 */
@Data
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@Schema(description ="客户关系发票回执VO")
public class CrmOnInvoiceVO extends AppVO {
