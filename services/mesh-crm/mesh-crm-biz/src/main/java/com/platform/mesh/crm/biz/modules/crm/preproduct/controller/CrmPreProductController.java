...
public class CrmPreProductController extends BaseController{
    ...
    public Result<CrmPreProductVO> editPreProduct(@Validated @RequestBody DataEditSimpDTO dataEditDTO) {
        CrmPreProduct crmPreProduct = crmPreProductService.editData(dataEditDTO, CrmPreProduct.class, CrmPreProductData.class);
        return Result.success(BeanUtil.copyProperties(crmPreProduct,CrmPreProductVO.class));
    }
   ...
   /**
    ...
    public Result<ImportVO> importPreProduct(@RequestParam("moduleId") Long moduleId, @RequestParam("formId") Long formId, @RequestParam("file") MultipartFile file) {
        DataImportDTO importDTO = new DataImportDTO();
        importDTO.setModuleId(moduleId);
        importDTO.setFormId(formId);
        importDTO.setFile(file);
        return Result.success(crmPreProductService.importData(importDTO, CrmPreProduct.class, CrmPreProductData.class));
    }
