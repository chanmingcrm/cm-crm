package com.platform.mesh.crm.biz.modules.crm.allgoal.domain.vo;
...
/**
 * @description 客户关系目标VO
 * @author 蝉鸣
 */
@Data
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@Schema(description ="客户关系目标VO")
public class CrmAllGoalVO extends BaseVO {
