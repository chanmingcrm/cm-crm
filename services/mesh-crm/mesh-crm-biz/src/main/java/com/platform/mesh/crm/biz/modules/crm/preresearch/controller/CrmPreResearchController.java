...
public class CrmPreResearchController extends BaseController{
    ...
    public Result<CrmPreResearchVO> editPreResearch(@Validated @RequestBody DataEditSimpDTO dataEditDTO) {
        CrmPreResearch crmPreResearch = crmPreResearchService.editData(dataEditDTO, CrmPreResearch.class);
        return Result.success(BeanUtil.copyProperties(crmPreResearch,CrmPreResearchVO.class));
    }
   ...
   /**
    ...
    public Result<Boolean> importPreResearch(@RequestParam("moduleId") Long moduleId,@RequestParam("formId") Long formId,@RequestParam("file") MultipartFile file) {
        return Result.success(crmPreResearchService.importData(moduleId,formId,file, CrmPreResearch.class, CrmPreResearchData.class));
    }
