package com.platform.mesh.crm.biz.modules.tmp.appr.approvaldata.domain.dto;
...
@Schema(description ="OA办公审批数据DTO")
public class TmpOaApprovalDataDTO extends BaseDTO {
