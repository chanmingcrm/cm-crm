package com.platform.mesh.crm.biz.modules.crm.oncontract.domain.vo;
...
/**
 * @description 客户关系合同签订VO
 * @author 蝉鸣
 */
@Data
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@Schema(description ="客户关系合同签订VO")
public class CrmOnContractVO extends AppVO {
