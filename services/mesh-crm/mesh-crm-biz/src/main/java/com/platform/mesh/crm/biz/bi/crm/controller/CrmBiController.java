...
public class CrmBiController extends BaseController{
	...
	public Result<SimpVO> biCustomerNew(@RequestBody BiDTO biDTO) {
	...
	public Result<SimpVO> biContactsNew(@RequestBody BiDTO biDTO) {
	...
	public Result<SimpVO> biBusinessNew(@RequestBody BiDTO biDTO) {
	...
	public Result<SimpVO> biContractNew(@RequestBody BiDTO biDTO) {
	...
	public Result<SimpVO> biFollowNew(@RequestBody BiDTO biDTO) {
	...
	public Result<SimpVO> biContractMoney(@RequestBody BiDTO biDTO) {
	...
	public Result<SimpVO> biBusinessMoney(@RequestBody BiDTO biDTO) {
	...
	public Result<SimpVO> biPaymentMoney(@RequestBody BiDTO biDTO) {
	...
	public Result<List<SimpVO>> biContractEstAndAct(@RequestBody BiDTO biDTO) {
	...
	public Result<SimpVO> biAchieveEstAndAct(@RequestBody ModuleBiDTO biDTO) {
