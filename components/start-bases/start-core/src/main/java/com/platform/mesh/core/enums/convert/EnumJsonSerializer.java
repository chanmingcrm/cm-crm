...
// */
//@Slf4j
//public class EnumJsonSerializer<T extends BaseEnum<?, V>, V extends Serializable> extends ValueSerializer<T> {
//
//
//    /**
//     * 功能描述:
...
//     */
//    @Override
//    public void serialize(T t, JsonGenerator jsonGenerator, SerializationContext serializationContext) throws JacksonException {
//        if (Objects.isNull(t)) {
//            jsonGenerator.writeNull();
//            return;
//        }
//        //        // 写入原本字段的值
////        jsonGenerator.writeStartObject(t.getValue());
////
////        // 获取字段名
...
////                jsonGenerator.writeStartObject(currentName + upperCaseFirstString(field.getName()), field.get(t));
////            } catch (IOException e) {
