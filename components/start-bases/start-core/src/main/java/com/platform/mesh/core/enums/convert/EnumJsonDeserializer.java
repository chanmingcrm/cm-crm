...
//@NoArgsConstructor
//@AllArgsConstructor
//public class EnumJsonDeserializer<T extends BaseEnum<?, V>, V extends Serializable> extends ValueDeserializer<T> {
//
...
//            return BaseEnum.getEnumByValue(clazz, value);
//        }
//        try {
