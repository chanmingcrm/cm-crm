...
//        if (baseInterface instanceof ParameterizedType && ((ParameterizedType) baseInterface).getActualTypeArguments().length == NumberConst.NUM_2) {
//            // 获取父接口的泛型类型
...
//                    return BaseEnum.getEnumByValue(targetType, value);
//                }
//                try {
