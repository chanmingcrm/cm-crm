 ...
 */
@Service
public class LogicBtFactoryImpl implements LogicRefService {

    private final static Logger log = LoggerFactory.getLogger(LogicBtFactoryImpl.class);
    ...
    public <T> QueryWrapper<T> sqlWrapper(QueryWrapper<T> wrapper, CondDTO condDTO){
        ...
        return wrapper.between(condDTO.getColumnMac(), CollUtil.getFirst(condDTO.getSearchValues()),CollUtil.getLast(condDTO.getSearchValues()));
    };
    ...
    public <T> QueryWrapper<T> sqlDataWrapper(QueryWrapper<T> wrapper, CondDTO condDTO){
        ...
        wrapper.between(SearchColumnConst.DATA_COLUMN_VALUE, CollUtil.getFirst(condDTO.getSearchValues()),CollUtil.getLast(condDTO.getSearchValues()));
        return wrapper;
    };
