...
public interface RemoteOrgMemberService {
	 ...
	 * @author 蝉鸣
	 */
	@PostMapping(value = "/api/org/member/by/ids", headers = HttpConst.HEADER_FROM_IN)
	 ...
	 * @author 蝉鸣
	 */
	@PostMapping(value = "/api/org/member/by/user/ids", headers = HttpConst.HEADER_FROM_IN)
	 ...
	 * @author 蝉鸣
	 */
	@GetMapping(value = "/api/org/member/by/user/{userId}", headers = HttpConst.HEADER_FROM_IN)
	Result<OrgMemberBO> getOrgMemberByUserId(@PathVariable("userId") Long userId);
	 ...
	 * @author 蝉鸣
	 */
	@PostMapping(value = "/api/org/level/by/ids", headers = HttpConst.HEADER_FROM_IN)
	...
	Result<OrgMemberRelBO> getOrgMemberUserDefaultRelByUserId(@RequestParam("userId") Long userId);
	 ...
	 * @author 蝉鸣
	 */
	@GetMapping(value = "/api/org/member/leader/direct/by/account/id", headers = HttpConst.HEADER_FROM_IN)
	Result<OrgMemberBO> getLeaderDirect(@RequestParam("accountId") Long accountId);
	 ...
	 * @author 蝉鸣
	 */
	@GetMapping(value = "/api/org/member/leader/loop/by/account/id", headers = HttpConst.HEADER_FROM_IN)
	Result<List<OrgMemberBO>> getLeaderLoop(@RequestParam("accountId") Long accountId);
}
