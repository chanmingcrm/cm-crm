 ...
 */
@Service
public class ProcessPassPassFactoryImpl implements ProcessPassService<BpmInstProcess> {

    private final static Logger log = LoggerFactory.getLogger(ProcessPassPassFactoryImpl.class);
