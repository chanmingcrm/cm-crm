 ...
 */
@Service
public class NodePassPassFactoryImpl implements NodePassService<BpmInstNode> {

    private final static Logger log = LoggerFactory.getLogger(NodePassPassFactoryImpl.class);
