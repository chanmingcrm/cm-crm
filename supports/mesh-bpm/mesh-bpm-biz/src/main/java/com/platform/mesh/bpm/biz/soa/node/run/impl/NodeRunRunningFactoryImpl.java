 ...
 */
@Service
public class NodeRunRunningFactoryImpl implements NodeRunService<BpmInstNode> {

    private final static Logger log = LoggerFactory.getLogger(NodeRunRunningFactoryImpl.class);
    ...
    public BpmInstNode handle(BpmInstNode instNode) {
        ...
        //执行当前节点流出
        instNodeService.getServiceManual().midInstNode(instNode);
        return instNode;
    }
