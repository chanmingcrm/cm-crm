 ...
 */
@Service
public class NodeAuditSerialFactoryImpl implements NodeAuditService {

    private final static Logger log = LoggerFactory.getLogger(NodeAuditSerialFactoryImpl.class);
    ...
    public NodeAuditFlagEnum nodeAudit() {
        return NodeAuditFlagEnum.SIGN_SERIAL;
    }

    /**
     * 功能描述:
     * 〈节点校验是否通过:串签是指多个审批人按照既定的顺序依次进行审批，前一个审批人审批通过后，下一个审批人才能进行审批。〉
