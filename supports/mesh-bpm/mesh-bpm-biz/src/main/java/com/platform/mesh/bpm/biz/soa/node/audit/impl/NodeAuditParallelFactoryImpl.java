 ...
 */
@Service
public class NodeAuditParallelFactoryImpl implements NodeAuditService {

    private final static Logger log = LoggerFactory.getLogger(NodeAuditParallelFactoryImpl.class);
    ...
    public NodeAuditFlagEnum nodeAudit() {
        return NodeAuditFlagEnum.SIGN_PARALLEL;
    }

    /**
     * 功能描述:
     * 〈节点校验是否通过:并签是指所有会审节点参与人将同时收到流程任务，处理不分前后。〉
