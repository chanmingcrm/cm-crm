package com.platform.mesh.bpm.biz.modules.hist.event.service;
 ...
 * @author 蝉鸣
 */
public interface IBpmHistEventService extends IService<BpmHistEvent> {
     ...
     * @author 蝉鸣
     */
    List<BpmHistEvent> selectEventsByInstProcessIdId(Long instProcessId);
     ...
     * @author 蝉鸣
     */
    List<BpmHistEvent> selectEventByInstNodeId(Long instNodeId);
     ...
     * @author 蝉鸣
     */
    List<BpmHistEvent> selectEventByInstActionId(Long instActionId);
     ...
     * @author 蝉鸣
     */
    BpmHistEvent addEventInst(BpmHistEvent instEvent);
