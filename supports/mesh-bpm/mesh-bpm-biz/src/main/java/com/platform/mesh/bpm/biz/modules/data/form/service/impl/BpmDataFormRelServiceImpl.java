package com.platform.mesh.bpm.biz.modules.data.form.service.impl;
...
import com.platform.mesh.bpm.biz.modules.data.form.exception.DataFormRelExceptionEnum;
import com.platform.mesh.bpm.biz.modules.data.form.mapper.BpmDataFormRelMapper;
import com.platform.mesh.bpm.biz.modules.data.form.service.IBpmDataFormRelService;
import com.platform.mesh.bpm.biz.modules.data.form.service.manual.BpmDataFormRelServiceManual;
...
public class BpmDataFormRelServiceImpl extends ServiceImpl<BpmDataFormRelMapper, BpmDataFormRel> implements IBpmDataFormRelService {
     ...
     */
    @Override
    public List<BpmDataFormRel> getDataFormRel(BpmDataFormRelDTO relDTO) {
        if(ObjectUtil.isEmpty(relDTO.getParentModuleId())
            && ObjectUtil.isEmpty(relDTO.getModuleId())
            && ObjectUtil.isEmpty(relDTO.getFormId())
        ){
            return CollUtil.newArrayList();
        }
        return this.getBaseMapper().getDataFormRelByFormId(relDTO);
    }
