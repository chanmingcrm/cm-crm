...
@Service
public class EventRelCustomFactoryImpl implements EventRelService {

    private final static Logger log = LoggerFactory.getLogger(EventRelCustomFactoryImpl.class);
    ...
    public EventRelEnum eventRel() {
        return EventRelEnum.USER_CUSTOM;
    }
