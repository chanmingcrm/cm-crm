package com.platform.mesh.bpm.biz.modules.data.nodedata.domain.vo;
...
/**
 * @description 业务数据实例流程节点表单数据VO
 * @author 蝉鸣
 */
@Data
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@Schema(description ="业务数据实例流程节点表单数据VO")
public class BpmDataFormNodeDataVO extends BaseVO {
