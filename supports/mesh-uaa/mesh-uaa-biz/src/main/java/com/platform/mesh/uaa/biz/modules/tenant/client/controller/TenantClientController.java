...
public class TenantClientController extends BaseController{
	 ...
	 * @author 蝉鸣
	 */
	@Operation(summary = "获取授权客户端租户关系分页")
	...
	public Result<PageVO<TenantClientVO>> selectPage(@RequestBody PageDTO pageDTO) {
        ...
        MPage<TenantClient> page = tenantClientService.lambdaQuery().page(clientMPage);
     ...
     * @author 蝉鸣
     */
    @Operation(summary = "获取当前授权客户端租户关系信息")
     ...
     * @author 蝉鸣
     */
    @Operation(summary = "新增授权客户端租户关系")
    @Log(moduleName = "授权客户端租户关系管理", operateType = OperateTypeEnum.INSERT)
     ...
     * @author 蝉鸣
     */
    @Operation(summary = "修改授权客户端租户关系")
    @Log(moduleName = "授权客户端租户关系管理", operateType = OperateTypeEnum.UPDATE)
   ...
   /**
     ...
     * @author 蝉鸣
     */
    @Operation(summary = "删除授权客户端租户关系")
    @Log(moduleName = "授权客户端租户关系管理", operateType = OperateTypeEnum.DELETE)
