...
public class CustomOAuth2AccessTokenGenerator implements OAuth2TokenGenerator<OAuth2AccessToken> {
	...
	public OAuth2AccessToken generate(OAuth2TokenContext context) {
        ...
        if (CollUtil.isNotEmpty(context.getAuthorizedScopes())) {
	...
	/**
	 * 功能描述:
	 * 〈设置AccessTokenCustomizer〉
	 * Sets the {@link OAuth2TokenCustomizer} that customizes the
	 * {@link OAuth2TokenClaimsContext#getClaims() claims} for the {@link OAuth2AccessToken}.
	 * @param accessTokenCustomizer  {@link OAuth2TokenCustomizer} that customizes the
	...
	/**
	 * @description 〈自定义OAuth2AccessTokenClaims〉
	 * @author 蝉鸣
	 */
